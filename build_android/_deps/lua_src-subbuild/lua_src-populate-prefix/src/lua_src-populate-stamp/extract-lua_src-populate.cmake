...
#
get_filename_component(filename "/home/puffy/dropCast/build_android/_deps/lua_src-subbuild/lua_src-populate-prefix/src/lua-5.4.6.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/puffy/dropCast/build_android/_deps/lua_src-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lua_src-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lua_src-populate${i}")
